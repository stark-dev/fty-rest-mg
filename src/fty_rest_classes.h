...
#endif
#ifndef WEB_SRC_TOPOLOGY_XLOCATION_T_DEFINED
typedef struct _web_src_topology_xlocation_t web_src_topology_xlocation_t;
#define WEB_SRC_TOPOLOGY_XLOCATION_T_DEFINED
#endif
#ifndef WEB_SRC_TOPOLOGY_XPOWER_T_DEFINED
