...
This package contains shared library for fty_rest: rest api for auth convergence
...
This package contains development files for fty_rest: rest api for auth convergence
